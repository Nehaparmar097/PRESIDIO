// <auto-generated />
using System;
using EmployeeRequestTrackerdb;
...
namespace EmployeeRequestTrackerdb.Migrations
{
    ...
    [Migration("20240509073832_First")]
    partial class First
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeRequestTrackerdb.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeRequestTrackerdb.Request", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerdb.Request", b =>
                {
                    b.HasOne("EmployeeRequestTrackerdb.Employee", "RequestClosedByEmployee")
                        .WithMany("RequestsClosed")
                        .HasForeignKey("RequestClosedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EmployeeRequestTrackerdb.Employee", "RaisedByEmployee")
