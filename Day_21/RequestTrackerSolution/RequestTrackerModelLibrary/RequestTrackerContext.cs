...
namespace RequestTrackerModelLibrary
{
    public class RequestTrackerContext:DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-QL1TE6V\SQLEXPRESS;Integrated Security=true;Initial Catalog=dbEmployeeRequestTracker;");
        }
        public DbSet<Employee> Employees { get; set; }
        public DbSet<Request> Requests { get; set; }
        public DbSet<RequestSolution> RequestSolutions { get; set; }
        public DbSet<SolutionFeedback> Feedbacks { get; set; }
        public object SolutionFeedbacks { get; set; }
